...
export default function PageHeader({ title, description }: {
  ...
  return (
    <section className="relative z-50 w-full h-[250px] md:h-[450px] lg:h-[350px] overflow-hidden">
      <HeaderGradient className="z-10" />
      <div className="relative z-20 container mx-auto px-4 flex flex-col items-start justify-end pb-12 h-full text-right">
